...
| `write_report` | success | 0.99 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1379.54 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `scan_frontend_contracts` | success | 3.25 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
...
| `find_openapi_specs` | success | 19.16 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `parse_openapi_contracts` | success | 1.57 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 5.21 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `list_project_files` | success | 0.98 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 2.99 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.04 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
| `generate_contract_report` | success | 1307.17 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `list_project_files` | success | 1.11 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 3.37 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.24 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 0.87 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.33 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `list_project_files` | success | 1.92 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `list_project_files` | success | 1.14 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `find_openapi_specs` | success | 21.06 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `find_openapi_specs` | success | 1.38 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `get_changed_files` | success | 81.31 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `get_changed_files` | success | 53.53 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `parse_openapi_contracts` | success | 1.67 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `parse_openapi_contracts` | success | 1.55 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 6.92 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `compare_backend_to_openapi` | success | 6.11 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `scan_frontend_contracts` | success | 3.34 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.79 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `compare_contracts` | success | 0.26 | fe=2 be=2 | 6 mismatch(es); High=3 |
| `list_project_files` | success | 1.15 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 2.18 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 3.35 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 0.92 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.93 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1216.62 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `get_latest_report` | success | 11.25 | reports_dir='C:\\dev\\projects\\contract-lens\\contractlens-reports' | Latest report body 53616 character(s) |
| `list_mcp_resources` | success | 0.05 |  | 6 resource URI(s) |
| `list_mcp_resources` | success | 0.01 |  | 6 resource URI(s) |
| `read_mcp_resource` | success | 11.37 | uri='contractlens://reports/latest' | status=ok; body 53616 character(s) |
| `read_mcp_resource` | success | 0.71 | uri='contractlens://reports/latest' | status=ok; body 53616 character(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `get_mcp_prompt` | success | 0.13 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
| `get_mcp_prompt` | success | 0.04 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
| `list_project_files` | success | 1.1 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 2.88 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.79 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 1.05 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.08 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `scan_frontend_contracts` | success | 3.13 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.65 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `compare_contracts` | success | 0.35 | fe=2 be=2 | 6 mismatch(es); High=3 |
| `find_openapi_specs` | success | 18.54 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `parse_openapi_contracts` | success | 1.82 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
...
| `list_project_files` | success | 1.02 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 2.76 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 3.47 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
| `write_report` | success | 0.89 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1245.8 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `list_project_files` | success | 2.12 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 3.45 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.05 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
| `list_project_files` | success | 1.19 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `list_project_files` | success | 2.38 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `find_openapi_specs` | success | 21.53 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `find_openapi_specs` | success | 1.14 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `get_changed_files` | success | 44.27 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `get_changed_files` | success | 34.99 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `parse_openapi_contracts` | success | 1.73 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `parse_openapi_contracts` | success | 1.77 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 8.17 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `compare_backend_to_openapi` | success | 5.7 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `scan_frontend_contracts` | success | 3.61 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.04 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
| `list_project_files` | success | 1.06 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 3.12 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.88 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 1.71 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.02 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1256.11 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `get_latest_report` | success | 15.8 | reports_dir='C:\\dev\\projects\\contract-lens\\contractlens-reports' | Latest report body 60714 character(s) |
| `list_mcp_resources` | success | 0.01 |  | 6 resource URI(s) |
| `list_mcp_resources` | success | 0.01 |  | 6 resource URI(s) |
| `read_mcp_resource` | success | 14.38 | uri='contractlens://reports/latest' | status=ok; body 60714 character(s) |
| `read_mcp_resource` | success | 0.72 | uri='contractlens://reports/latest' | status=ok; body 60714 character(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `get_mcp_prompt` | success | 0.03 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
| `get_mcp_prompt` | success | 0.04 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
...
| `scan_backend_routes` | success | 4.28 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 0.89 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.15 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `scan_frontend_contracts` | success | 3.85 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.86 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `compare_contracts` | success | 0.37 | fe=2 be=2 | 6 mismatch(es); High=3 |
| `scan_frontend_auth` | success | 1.88 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 auth finding(s) |
| `scan_backend_auth` | success | 2.03 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 auth finding(s) |
| `compare_auth_contracts` | success | 0.28 | fe_contracts=2 be_contracts=2 fe_auth=1 be_auth=2 | 3 auth mismatch(es) |
| `find_openapi_specs` | success | 17.99 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `parse_openapi_contracts` | success | 2.52 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 5.11 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `list_project_files` | success | 1.23 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 4.4 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 3.67 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
| `write_report` | success | 0.87 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1294.75 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `list_project_files` | success | 0.91 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `list_project_files` | success | 0.98 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `find_openapi_specs` | success | 20.78 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `find_openapi_specs` | success | 1.37 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `get_changed_files` | success | 55.61 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `get_changed_files` | success | 389.52 | root='C:\\dev\\projects\\contract-lens' include_cached=True | 0 path(s); git=False |
| `parse_openapi_contracts` | success | 2.21 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `parse_openapi_contracts` | success | 2.27 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 9.43 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
...
| `scan_frontend_contracts` | success | 3.36 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.39 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `scan_frontend_auth` | success | 3.14 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 auth finding(s) |
| `scan_frontend_auth` | success | 3.06 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 auth finding(s) |
| `scan_backend_auth` | success | 3.04 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 auth finding(s) |
| `scan_backend_auth` | success | 2.05 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 auth finding(s) |
...
| `evaluate_ci_gate` | success | 0.02 | fail_on='High' n=6 | passed=False; exit_code=1 |
| `evaluate_ci_gate` | success | 0.01 | fail_on='High' n=0 | passed=True; exit_code=0 |
| `list_project_files` | success | 1.22 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 4.15 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.13 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 1.01 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 0.97 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `list_project_files` | success | 1.0 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 3.52 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.44 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 1.14 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.24 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1629.32 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `get_latest_report` | success | 12.09 | reports_dir='C:\\dev\\projects\\contract-lens\\contractlens-reports' | Latest report body 70834 character(s) |
| `list_mcp_resources` | success | 0.01 |  | 6 resource URI(s) |
| `list_mcp_resources` | success | 0.01 |  | 6 resource URI(s) |
| `read_mcp_resource` | success | 11.92 | uri='contractlens://reports/latest' | status=ok; body 70834 character(s) |
| `read_mcp_resource` | success | 1.14 | uri='contractlens://reports/latest' | status=ok; body 70834 character(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `list_mcp_prompts` | success | 0.01 |  | 5 prompt template(s) |
| `get_mcp_prompt` | success | 0.04 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
| `get_mcp_prompt` | success | 0.06 | name='explain_contract_mismatch' | Prompt string 244 character(s) |
| `list_project_files` | success | 1.04 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 3.36 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.88 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 0.93 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
...
| `scan_frontend_contracts` | success | 3.36 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.99 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `compare_contracts` | success | 0.38 | fe=2 be=2 | 6 mismatch(es); High=3 |
| `scan_frontend_auth` | success | 2.28 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 auth finding(s) |
| `scan_backend_auth` | success | 2.09 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 auth finding(s) |
| `compare_auth_contracts` | success | 0.26 | fe_contracts=2 be_contracts=2 fe_auth=1 be_auth=2 | 3 auth mismatch(es) |
| `find_openapi_specs` | success | 19.09 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `parse_openapi_contracts` | success | 1.59 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 5.12 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `list_project_files` | success | 1.2 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 6 file path(s) |
| `scan_frontend_contracts` | success | 4.03 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 5.58 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `write_report` | success | 1.38 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `write_report` | success | 1.57 | path='C:\\dev\\projects\\contract-lens\\contractlens-reports\\contractlens-repor | Wrote OK -> contractlens-report-create-project-upload-file.md |
| `generate_contract_report` | success | 1314.55 | feature='Create Project + Upload File' root='C:\\dev\\projects\\contract-lens\\e | mismatch_count=9; report=contractlens-report-create-project-upload-file.md |
| `scan_frontend_contracts` | success | 4.52 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 6.22 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
| `compare_contracts` | success | 0.65 | fe=2 be=2 | 6 mismatch(es); High=3 |
| `scan_frontend_auth` | success | 2.82 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 auth finding(s) |
| `scan_backend_auth` | success | 3.02 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 auth finding(s) |
| `compare_auth_contracts` | success | 0.2 | fe_contracts=2 be_contracts=2 fe_auth=1 be_auth=2 | 3 auth mismatch(es) |
| `find_openapi_specs` | success | 20.66 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 1 spec path(s); yaml_supported=True |
| `parse_openapi_contracts` | success | 2.03 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 operation(s); specs=1 |
| `compare_backend_to_openapi` | success | 7.23 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' backend_rows=0 | 3 openapi drift mismatch(es); High=1 |
| `scan_documentation_contracts` | success | 2.02 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 7 doc claim(s) |
| `compare_documentation_drift` | success | 1.14 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' claims=7 fe=2  | 2 documentation drift row(s) |
| `list_project_files` | success | 1.18 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 7 file path(s) |
| `scan_frontend_contracts` | success | 2.93 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 contract(s) |
| `scan_backend_routes` | success | 4.82 | root='C:\\dev\\projects\\contract-lens\\examples\\sample_project' | 2 route(s) |
...
|---|---|---|---|---|---:|
| Frontend Analyst | Extract frontend API expectations | `scan_frontend_contracts` | root=C:\dev\projects\contract-lens\examples\sample_project | Detected 2 frontend API calls | 15.89 |
| Backend Analyst | Extract backend routes/DTOs | `scan_backend_routes` | root=C:\dev\projects\contract-lens\examples\sample_project | Detected 2 backend routes | 17.45 |
| Contract Reviewer | Compare contracts (+ OpenAPI drift) | `compare_contracts` | fe=2 be=2 | 9 mismatch(es); openapi drift=3 | 0.18 |
| Report Writer | Build Markdown audit report | `build_markdown_report` | path=C:\dev\projects\contract-lens\contractlens-reports\cont | 77874 chars | 388.98 |
